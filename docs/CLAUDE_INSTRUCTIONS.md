...
- **activities**: Authenticated users can list/view/create; creators can update; admins can delete
- **participations**: Authenticated users can list/view/create; users can delete own; admins can delete any
- **point_transactions**: Authenticated users can list/view; admins can create; no updates/deletes
- **news**: Authenticated users can list/view; admins can create/update/delete
- **users**: Users can only see themselves directly, but `expand` on relations includes user data

**Important:** Always use `expand` to get related user data (e.g., `expand: 'creator'` on activities).
